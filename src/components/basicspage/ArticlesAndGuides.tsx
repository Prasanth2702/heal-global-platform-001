...
const PatientsGuideSection = () => {
  ...
  const guides = [
    {
      id: 1,
      title: "How to Book an Appointment on pmhssmarthealth.com",
      category: "patients",
      excerpt:
      ...
      content: {
        introduction:
          "Booking appointments through pmhssmarthealth.com is simple and convenient. Follow these steps to schedule your next visit:",
        steps: [
          "Log in to your pmhssmarthealth.com account",
    ...
    },
    {
      ...
      content: {
        introduction:
          "pmhssmarthealth.com makes bed reservations simple. Here's how to secure a bed for your hospital stay:",
        steps: [
    ...
    },
    {
      ...
      content: {
        introduction:
          "Get your health checkups done easily through pmhssmarthealth.com:",
        steps: [
...
const MedicalProfessionalsGuideSection = () => {
  ...
  const guides = [
    {
      id: 1,
      title: "Setting Up Your Doctor Profile on pmhssmarthealth.com",
      category: "doctors",
      excerpt:
      ...
      content: {
        ...
        steps: [
          "Register as a healthcare provider on pmhssmarthealth.com",
    ...
    },
    {
      ...
      content: {
        introduction:
          "pmhssmarthealth.com makes telemedicine easy. Here's how to conduct virtual consultations:",
        steps: [
...
const FacilitiesGuideSection = () => {
  ...
  const guides = [
    {
      id: 1,
      title: "Listing Your Hospital on pmhssmarthealth.com",
      category: "hospitals",
      excerpt:
      ...
      content: {
        introduction:
          "Get your hospital or clinic listed on pmhssmarthealth.com with these steps:",
        steps: [
  ...
  const access = [
    {
      id: "faq-1",
      category: "Account",
      title: "How do I create a patient account on pmhssmarthealth.com?",
      readTime: "2 min read",
      ...
      content: {
        ...
        steps: [
          "Visit pmhssmarthealth.com and click 'Sign Up'",
    ...
    },
    {
      ...
      icon: <Stethoscope className="h-5 w-5" />,
      excerpt:
        "Step-by-step guide to creating a professional account on PMHS Smart Health.",
      content: {
    ...
    },
    {
      ...
      content: {
        ...
        steps: [
          ...
          "If issues continue, contact support@pmhssmarthealth.com",
        ],
      },
    },
  ];
...
const PaymentFAQs = () => {
  const paymentFAQs = [
    ...
    {
      id: 4,
      question: "Is my payment information secure on PMHS Smart Health?",
      answer:
    ...
    },
    {
      ...
      answer: (
        <>
          ...
          <a
            href="mailto:payments@pmhssmarthealth.com"
            className="text-blue-600 underline"
          >
            payments@pmhssmarthealth.com
          </a>{" "}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ...
              and managing your healthcare on pmhssmarthealth.com
            </p>
          </div>
