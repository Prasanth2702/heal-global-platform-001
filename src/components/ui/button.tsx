  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Medical Portal Variants
        patient: "bg-gradient-patient text-patient-foreground shadow-medium hover:shadow-strong transition-smooth",
        ...
        heroSecondaryOutline: "bg-transparent border-2 border-white text-white hover:bg-white hover:text-black hover:scale-105 transition-bounce",
        heroTertiary: "bg-gradient-hero text-white shadow-medium hover:shadow-strong hover:scale-105 transition-bounce",
        heroTertiaryOutline: "bg-transparent border-2 border-white text-white hover:bg-white hover:text-black hover:scale-105 transition-bounce",
      },
      size: {
