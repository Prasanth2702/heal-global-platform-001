            ...
            <CardContent className="space-y-6">
              <section>
                ...
                <div className="space-y-3 text-gray-700">
                  <p>
                    <strong>Personal Information:</strong> When you book appointments or reserve beds through pmhssmarthealth.com, we collect personal details including your full name, date of birth, contact information (phone, email), and emergency contact information.
                  </p>
                  <p>
              ...
              <section>
                ...
                <div className="space-y-3 text-gray-700">
                  <p>
                    pmhssmarthealth.com services are intended for individuals 18 years and older. For minors requiring healthcare services, bookings must be made by a parent or legal guardian who accepts responsibility for all provided information.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="space-y-3 text-gray-700">
                  <p>
                    We may update this Privacy Policy periodically to reflect changes in our practices or legal requirements. We will notify users of significant changes through the platform or via email. Your continued use of pmhssmarthealth.com after changes constitutes acceptance of the updated policy.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="space-y-3 text-gray-700">
                  ...
                  <p className="font-medium">
                    Email: privacy@pmhssmarthealth.com
                  </p>
                  <p>
                    Or write to us at:
                    <br />
                  PMHS Smart Health LLC
                    <br />
                    128 City Road
                    <br />
                    London, EC1V 2NX
