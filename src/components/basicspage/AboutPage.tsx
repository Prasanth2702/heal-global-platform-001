      ...
      <div className="min-h-screen p-4 md:p-8 bg-gray-50">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-6">
          ...
          <div className="flex-1 bg-white p-5 md:p-6 shadow rounded-lg">
            <h2 className="text-xl md:text-2xl font-bold mb-4 flex items-center gap-2">
              ...
              About PMHS Smart Health
            </h2>
            <p className="text-gray-700 text-sm md:text-base">
              <strong className="bold">pmhssmarthealth.com</strong> is a revolutionary digital healthcare platform 
            ...
            <p className="text-gray-700 mt-4 text-sm md:text-base">
             ...
             pmhssmarthealth.com offers a comprehensive platform where patients can easily find and book 
            ...
            <p className="text-gray-700 mt-4 text-sm md:text-base">
              ...
              emergency care, or planned hospitalization, pmhssmarthealth.com connects you with the right 
        ...
        <div className="max-w-6xl mx-auto mt-8 bg-white p-5 md:p-6 shadow rounded-lg">
          ...
          <p className="text-gray-700 mb-6 text-sm md:text-base">
            Meet the experts behind <strong>pmhssmarthealth.com</strong> – a unique
            ...
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-6">
              <div className="flex-1 bg-white p-5 md:p-6 shadow rounded-lg">
                ...
                <p className="text-sm md:text-base font-medium text-gray-800">
                  Founder & Chairman – pmhssmarthealth.com
                </p>
                <p className="text-gray-700 mt-2 text-sm md:text-base">
                  Dr. Mohammed Ahetasham is a visionary healthcare innovator,
                  accomplished Radiologist, and Founder & Chairman of pmhssmarthealth.com. 
              ...
              <div className="flex-1 bg-white p-5 md:p-6 shadow rounded-lg">
                ...
                <p className="text-gray-700 mt-2 text-sm md:text-base">
                  ...
                  pmhssmarthealth.com's robust appointment and bed management platform.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto mt-8 bg-white p-5 md:p-6 shadow rounded-lg">
          ...
          <h3 className="text-base md:text-lg font-semibold mt-6">
            Why pmhssmarthealth.com Stands Out
          </h3>
          ...
          <p className="text-blue-700 font-semibold mt-5 text-sm md:text-base flex items-center gap-2">
            ...
            👉 Experience hassle-free healthcare with <strong>pmhssmarthealth.com</strong> Today!
          </p>
        </div>
      </div>
      <Footer/>
