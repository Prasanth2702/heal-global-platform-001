            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <div className="space-y-3 text-gray-700">
                      <p className="font-medium text-blue-800">
                        Welcome to pmhssmarthealth.com – Your Trusted Healthcare Booking Platform
                      </p>
                      <p>
                        pmhssmarthealth.com is a digital platform that connects patients with healthcare providers for 
                ...
                <section>
                  ...
                  <div className="space-y-3 text-gray-700">
                    <p>
                      By accessing and using pmhssmarthealth.com, you accept and agree to
                ...
                <section>
                  ...
                  <div className="space-y-3 text-gray-700">
                    <p>
                      <strong>Appointment Booking:</strong> When you book an appointment through pmhssmarthealth.com, 
                ...
                <section>
                  ...
                  <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                    <div className="space-y-3 text-gray-700">
                      <p>
                        <strong>PLATFORM DISCLAIMER:</strong> pmhssmarthealth.com provides a booking platform only. 
                ...
                <section>
                  ...
                  <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                    <div className="space-y-3 text-gray-700">
                      ...
                      <p>
                        pmhssmarthealth.com is NOT an emergency service. If you are experiencing a medical emergency, 
                ...
                <section>
                  ...
                  <div className="space-y-3 text-gray-700">
                    <p>
                      ...
                      content are owned by pmhssmarthealth.com and protected by intellectual property laws.
                    </p>
                    <p>
                ...
                <section>
                  ...
                  <div className="space-y-3 text-gray-700">
                    <p>
                     ...
                     pmhssmarthealth.com shall be resolved through good-faith negotiations. If a resolution cannot 
                ...
                <section>
                  ...
                  <div className="space-y-3 text-gray-700">
                    ...
                    <p>
                      ...
                      <p><strong>Support:</strong> <a href="mailto:support@pmhssmarthealth.com" className="text-blue-600 hover:underline">support@pmhssmarthealth.com</a></p>
                    </p>
                  </div>
                  </div>
                </section>
